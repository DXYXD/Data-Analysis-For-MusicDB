...
def network():
	stopwords = []
	with open("D:\\Academic_work\\01_ERG3010\\Project\\lyricsAnalysis3\\stopwords.txt", 'r', encoding = 'utf-8-sig') as f:
		for line in f.readlines():
			stopwords.append(line.strip('\n'))
	word_list = []
	lyric_lines = []
	with open("D:\\Academic_work\\01_ERG3010\\Project\\lyricsAnalysis3\\lijianlyrics2.txt", 'r', encoding = 'utf-8-sig') as f:
		lyrics = f.read()
		lyrics = lyrics.split("+")
		for ly in lyrics:
			ly = ly.split('\n')
