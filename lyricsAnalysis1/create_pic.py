...
class NetEase():
    ...
    def song_detail(self, sid):
        ...
        res_data = self.http_request('GET', action)
        if res_data['songs'][0] is not None:
...
#         self.save_dir = save_dir
        self.save_dir = "D:\\Academic_work\\01_ERG3010\\Project\\lyricsAnalysis1\\Img"

        self.font_family = 'STFANGSO.TTF'
        ...
        self.netease_icon = 'D:\\Academic_work\\01_ERG3010\\Project\\lyricsAnalysis1\\netease_icon.png'
        self.icon_width = 25
